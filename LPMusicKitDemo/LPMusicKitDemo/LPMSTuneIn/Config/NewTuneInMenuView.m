...
- (void)setObject
{
    ...
    [view mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(menuWidth, view.frame.size.height));
    }];
    [self addSubview:self.homeBut];
    [self.homeBut mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(view.mas_left).offset(5);
        make.top.mas_equalTo(15);
        make.size.mas_equalTo(CGSizeMake(menuWidth, 40));
    }];
    
    [self addSubview:self.browseBut];
    [self.browseBut mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(view.mas_left).offset(5);
        make.top.mas_equalTo(self.homeBut.mas_bottom);
        make.size.mas_equalTo(CGSizeMake(menuWidth, 40));
    }];
    
    [self addSubview:self.favoriteBut];
    [self.favoriteBut mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(view.mas_left).offset(5);
        make.top.mas_equalTo(self.browseBut.mas_bottom);
        make.size.mas_equalTo(CGSizeMake(menuWidth, 40));
    }];
    ...
    [self.settingBut mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(view.mas_left).offset(5);
        make.top.mas_equalTo(self.favoriteBut.mas_bottom);
        make.size.mas_equalTo(CGSizeMake(menuWidth, 40));
    }];
}
...
- (UIButton *)homeBut
{
    if (!_homeBut)
    {
        ...
        [_homeBut setTitle:@"TuneIn" forState:UIControlStateNormal];
        [_homeBut setImage:[UIImage imageNamed:@"tunein_menu_home_n"] forState:UIControlStateNormal];
        [_homeBut setImage:[UIImage imageNamed:@"tunein_menu_home_d"] forState:UIControlStateSelected];
...
- (UIButton *)browseBut
{
    if (!_browseBut)
    {
        ...
        [_browseBut setTitle:LOCALSTRING(@"newtuneIn_Browse") forState:UIControlStateNormal];
        [_browseBut setImage:[UIImage imageNamed:@"tunein_menu_browse_n"] forState:UIControlStateNormal];
        [_browseBut setImage:[UIImage imageNamed:@"tunein_menu_browse_d"] forState:UIControlStateSelected];
...
- (UIButton *)customURLBut
{
    if (!_customURLBut)
    {
        ...
        [_customURLBut setTitle:LOCALSTRING(@"devicelist_Custom_URL") forState:UIControlStateNormal];
        [_customURLBut setImage:[UIImage imageNamed:@"tunein_custom_n"] forState:UIControlStateNormal];
        [_customURLBut setImage:[UIImage imageNamed:@"tunein_custom_d"] forState:UIControlStateSelected];
...
- (UIButton *)favoriteBut
{
    if (!_favoriteBut)
    {
        ...
        [_favoriteBut setTitle:LOCALSTRING(@"newtuneIn_Favorites") forState:UIControlStateNormal];
        [_favoriteBut setImage:[UIImage imageNamed:@"tunein_menu_favorites_n"] forState:UIControlStateNormal];
        [_favoriteBut setImage:[UIImage imageNamed:@"tunein_menu_favorites_d"] forState:UIControlStateSelected];
...
- (UIButton *)settingBut
{
    if (!_settingBut)
    {
        ...
        [_settingBut setTitle:LOCALSTRING(@"newtuneIn_Setting") forState:UIControlStateNormal];
        [_settingBut setImage:[UIImage imageNamed:@"tunein_menu_settings_n"] forState:UIControlStateNormal];
        [_settingBut setImage:[UIImage imageNamed:@"tunein_menu_settings_d"] forState:UIControlStateSelected];
