...
- (void)searchClick
{
    ...
    {
        [self.delegate selectMusicNavigationBar:TuneIn_NavBut_Search];
    }
}
...
- (void)settingClick
{
    if ([self.delegate respondsToSelector:@selector(selectMusicNavigationBar:)])
    {
        [self.delegate selectMusicNavigationBar:TuneIn_NavBut_Setting];
    }
}
...
- (void)backButClick
{
    if ([self.delegate respondsToSelector:@selector(selectMusicNavigationBar:)])
    {
        [self.delegate selectMusicNavigationBar:TuneIn_NavBut_Back];
    }
}
...
- (UIBarButtonItem *)searchBut
{
    if (!_searchBut) {
        ...
        [search setImage:[UIImage imageNamed:@"tunein_search_title_n"] forState:UIControlStateNormal];
        [search setImage:[UIImage imageNamed:@"tunein_search_title_d"] forState:UIControlStateHighlighted|UIControlStateSelected];
...
- (UIBarButtonItem *)settingBut
{
    if (!_settingBut) {
        ...
        [setting setImage:[UIImage imageNamed:@"tunein_menu_title_n"] forState:UIControlStateNormal];
        [setting setImage:[UIImage imageNamed:@"tunein_menu_title_d"] forState:UIControlStateHighlighted|UIControlStateSelected];
...
- (UIBarButtonItem *)iconBut
{
    if (!_iconBut) {
        ...
        [iconBut setImage:[UIImage imageNamed:@"tunein_logo_title"] forState:UIControlStateNormal];
