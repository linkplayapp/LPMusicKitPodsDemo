...
//    self.backImage.backgroundColor = HWCOLORA(255, 255, 255, 0.1);
    self.searchImage.image = [UIImage imageNamed:@"tunein_search_title_n"];
    ...
    self.searchImage.tintColor = [UIColor whiteColor];
}
...
- (void)textFieldDidBeginEditing:(UITextField *)textField
{
    ...
    {
        [self.delegate newTuneInSearchBarView:1 Text:textField.text];
    }
}
...
- (void)textFieldDidEndEditing:(UITextField *)textField
{
    if ([self.delegate respondsToSelector:@selector(newTuneInSearchBarView:Text:)])
    {
        [self.delegate newTuneInSearchBarView:2 Text:textField.text];
    }
}
